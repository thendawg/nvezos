...
<head>
    ...
    <meta http-equiv="refresh" content="3;url=networksettings.php">
    <title>
	NvEZOS -  
	<?php
	echo exec('hostname');
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info">
                             Applying Hostname... You will be redirected back to the settings page after this is complete. For this operation to work properly the system MUST be restarted.
                        </div>                       
                    </div>
		</div>
	<?php
